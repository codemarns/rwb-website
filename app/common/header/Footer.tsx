...
export const Footer = () => {
  ...
  return (
    <footer className="h-auto w-full bg-gradient-to-b from-primary-950 to-neutral-950">
      <div className="h-auto w-full px-6 lg:px-8 py-16 md:py-20 xl:py-24 bg-black/20">
        {/* Grid Column: START */}
        <div className="CONTAINER w-full max-w-[1376px] mx-auto grid grid-cols-12 lg:gap-x-4 gap-y-10">
          {/* Grid: START */}
